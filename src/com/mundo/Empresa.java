...
public class Empresa {
	...
	public LineaCelular darLineaCelular() {
	...
	public double darCostoPromedioMinutosDesdeLineasNoAlternativas() {
		return darTotalCostoLlamadasDesdeLineasNoAlternativas() / darTotalMinutosDesdeLineasNoAlternativas();
	}
	public double darCostoPromedioMinutosDesdeLineasAlternativas() {
